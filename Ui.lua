...
local Library do
    ...
    local Instances = { } do
        ...
        Instances.MakeDraggable = function(self, Handle)
            ...
            local Gui = self.Instance
            local DragHandle = Handle and Handle.Instance or nil
            ...
            local Set = function(Input)
                ...
                self:Tween(TweenInfo.new(0.05, Enum.EasingStyle.Quart, Enum.EasingDirection.Out), {Position = UDim2New(StartPosition.X.Scale, StartPosition.X.Offset + DragDelta.X, StartPosition.Y.Scale, StartPosition.Y.Offset + DragDelta.Y)})
            end

            local function StartDrag(Input)
                local Target = DragHandle or Gui
                local MouseLocation = UserInputService:GetMouseLocation()
                local RelativePos = Vector2New(MouseLocation.X - Target.AbsolutePosition.X, MouseLocation.Y - Target.AbsolutePosition.Y)
                
                if DragHandle then
                    if RelativePos.X < 0 or RelativePos.X > Target.AbsoluteSize.X or RelativePos.Y < 0 or RelativePos.Y > Target.AbsoluteSize.Y then
                        return
                    end
                end
    ...
    do -- Element functions
        ...
        Library.Window = function(self, Data)
            ...
            local Window = {
                ...
                LogoSize = Data.LogoSize or Data.logosize or 22,
                ...
                Size = Data.Size or Data.size or UDim2New(0, 700, 0, 520),
            ...
            if Window.Watermark then
                Library:Watermark(Window.Watermark, Window.Logo)
            end
